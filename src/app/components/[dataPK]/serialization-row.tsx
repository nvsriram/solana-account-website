...
const SerializationRow = ({ serialization_status } : { serialization_status : SerializationStatusOption }) => {
    return (
        <tr>
            ...
            <td className={`text-md ${serialization_status % 2 ? "text-solana-green": "text-rose-500"}`}>
