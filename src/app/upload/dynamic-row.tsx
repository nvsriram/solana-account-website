    ...
    return (
        <tr>
            ...
            <td className="flex flex-row h-full items-center">
                ...
                <Tooltip message={<><b>{isDynamic ? "Dynamic" : "Static"}</b><br />Initial size:<br />{displaySize}<br />{space > MAX_FILE_SIZE ? <p className="text-rose-700">{`> ${MAX_FILE_SIZE/1e6} MB`}</p> : null}</>} condition={true} sx={`w-32 right-0 top-0 left-9`}>
